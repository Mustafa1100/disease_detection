...
const DengueCapture = () => {
  ...
  const handleContinue = () => {
    if (capturedImage) {
      localStorage.setItem("dengueKitPhoto", capturedImage);
      navigate("/questionnaire/dengue");
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 overflow-hidden">
          ...
          {!isLoading && !error && !capturedImage && (
            <div className="relative">
              ...
              />
              {/* NS-1 Kit frame guide */}
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-4 border-white rounded-lg w-80 h-48 opacity-50"></div>
                <div className="absolute top-4 left-4 bg-black/70 text-white px-3 py-2 rounded-lg text-sm">
                  {t("dengueCapture.kitViewer")}
                </div>
              </div>
              <div className="mt-6 flex justify-center">
                ...
                >
                  ...
                  <span>{t("dengueCapture.capture")}</span>
                </button>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  <span>{t("dengueCapture.retake")}</span>
                </button>
                <button
                ...
                >
                  ...
                  <span>{t("dengueCapture.continue")}</span>
                </button>
              </div>
            </div>
          )}
