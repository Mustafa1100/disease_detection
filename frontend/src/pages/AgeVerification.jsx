...
const AgeVerification = () => {
  ...
  const ageOptions = [
    {
      value: "under18",
      label: t("ageVerification.under18"),
    },
    {
      value: "above18",
      label: t("ageVerification.above18"),
    },
  ];
  ...
  const handleAgeSelect = (ageValue) => {
    ...
    setIsAnimating(true);
    // Store age selection in localStorage
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent text-center leading-[100px] leading-[100px]">
