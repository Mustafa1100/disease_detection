...
const EyesCapture = () => {
  ...
  const handleContinue = () => {
    if (capturedImage) {
      localStorage.setItem("eyesPhoto", capturedImage);
      navigate("/questionnaire/eyes");
    }
  };
          ...
          {!isLoading && !error && !capturedImage && (
            <div className="relative">
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-4 border-white rounded-full w-64 h-64 opacity-50"></div>
              </div>
              ...
              <div className="mt-6 flex justify-center">
                <button
                  ...
                  className="flex items-center space-x-3 px-8 py-4 bg-indigo-600 text-white rounded-full font-semibold text-lg hover:bg-indigo-700 transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <FaCamera className="text-2xl" />
                  <span>{t("eyesCapture.capture")}</span>
                </button>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  <span>{t("eyesCapture.retake")}</span>
                </button>
                <button
                ...
                >
                  ...
                  <span>{t("eyesCapture.continue")}</span>
                </button>
              </div>
            </div>
          )}
