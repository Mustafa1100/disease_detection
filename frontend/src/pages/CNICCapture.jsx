...
const CNICCapture = () => {
  ...
  const handleContinue = () => {
    if (capturedImage) {
      localStorage.setItem("cnicPhoto", capturedImage);
      console.log("CNIC captured and saved");
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 overflow-hidden">
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-gray-600 text-lg">{t("cnicCapture.loading")}</p>
            </div>
          )}
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex justify-center">
                ...
                >
                  ...
                  <span>{t("cnicCapture.capture")}</span>
                </button>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  <span>{t("cnicCapture.retake")}</span>
                </button>
                <button
                ...
                >
                  ...
                  <span>{t("cnicCapture.continue")}</span>
                </button>
              </div>
            </div>
          )}
